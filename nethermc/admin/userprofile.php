...
<div class="web-center">
    <div class="menu">
        ...
        <div class="menu-buttnos-box">
            ...
            <div class="button1"><p class="icon-cog"> Profile Settings</p></div>
            <hr class="button-hr">
            ...
            <div class="button"><a href="admlist.php"><p class="icon-cog"> Administracja</p></a></div>


        </div>
    </div>
    <div class="web-center-box">
        <div class="password">
            ...
            <div class="password-box">
                <form action="changepass.php" method="POST">
                    <input type="password" name="changepass" id="changepassid">
                    <input type="submit" id="submit" value="Zmien Hasło">
                </form>
            </div>
        </div>
    </div>
